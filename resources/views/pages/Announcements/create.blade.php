...
@endsection
@section('title')
    {{ trans('Announcements_trans.add_new') }}
@endsection
@section('PageTitle')
    {{ trans('Announcements_trans.add_new') }}
@endsection
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select" name="target_audience" required>
                                    ...
                                    <option value="all" {{ old('target_audience') == 'all' ? 'selected' : '' }}>{{ trans('Announcements_trans.audience_all') }}</option>
                                    <option value="admin" {{ old('target_audience') == 'admin' ? 'selected' : '' }}>{{ trans('Announcements_trans.audience_admin') }}</option>
                                    <option value="teachers" {{ old('target_audience') == 'teachers' ? 'selected' : '' }}>{{ trans('Announcements_trans.audience_teachers') }}</option>
                                    <option value="students" {{ old('target_audience') == 'students' ? 'selected' : '' }}>{{ trans('Announcements_trans.audience_students') }}</option>
                                    <option value="parents" {{ old('target_audience') == 'parents' ? 'selected' : '' }}>{{ trans('Announcements_trans.audience_parents') }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="datetime-local" class="form-control" name="publish_at" value="{{ old('publish_at') }}">
